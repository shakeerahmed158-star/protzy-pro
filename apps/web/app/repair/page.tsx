        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 bg-white border border-blue-100 shadow-sm rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-sm font-semibold text-zinc-700">
              ...
              Smart Repair Assistance

            </span>

          </div>

          <h1 className="text-5xl md:text-7xl font-black tracking-tight text-zinc-900">
          ...
          <p className="max-w-2xl mx-auto mt-6 text-lg md:text-xl text-zinc-600">
            ...
            diagnostics and doorstep repair support.
